...
const npcs = [{
  ...
  notes: "Trinia Sabor is a young but talented artist who's recent commission to paint the king's portrait has brought her increased fame.",
  associations: "none"
},{
  name: "Zellara",
  thumbnail: "http://static2.paizo.com/image/content/PathfinderAdventurePath/PZO1021-Zellara.jpg",
  ...
  name: "Ausio",
  thumbnail: "http://static2.paizo.com/image/content/PathfinderAdventurePath/PZO1021-Ausio.jpg",
  notes: "Ausio Carowyn is one of Korvosa's many nobles—an aristocracy increasingly out of touch with the commonfolk.",
  associations: "Noble"
},{
  name: "Boule",
  thumbnail: "http://static2.paizo.com/image/content/PathfinderAdventurePath/PZO1021-Boule.jpg",
  notes: "Boule is a successful businessman, but has long been rumored to be the leader of Korvosa's thieves' guild, the Cerulean Society.",
  associations: "Cerulean Society"
},{
  name: "Cressida",
  thumbnail: "http://static2.paizo.com/image/content/PathfinderAdventurePath/PZO1021-Cressida.jpg",
  notes: "Captain Cressida Kroft is the leader of the Korvosan Guard.",
  associations: "Korvosan Guard"
},{
  name: "Darb",
  thumbnail: "http://static2.paizo.com/image/content/PathfinderAdventurePath/PZO1021-Darb.jpg",
  notes: "Archbanker Darb Tuttle is the leader of the faith of Abadar in Korvosa.",
